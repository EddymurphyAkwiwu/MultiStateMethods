...
mod.ini          = bts_survreg(d          = dat$d, # censoring indicator, assumes values 1, 2, 3
                           ...
                           sig.prior.X    = 1,  # The sd=tau of a half normal distribution N+(0,tau^2) (X)
                           sig.prior.S    = 1,  # The sd=tau of a half normal distribution N+(0,tau^2) (S)
                           dist.X         = 'weibull', # Distribution of X
                           dist.S         = 'weibull', # Distribution of S
                           fix.sigma.X    = T,         # Should sigma of X be fixed at its prior value?
                           fix.sigma.S    = T,         # Should sigma of S be fixed at its prior value? (use e.g. to specify exponential distribution)
